...
export default function performScript(
    key: string & keyof TextViewer.Config['scriptNames'] | (string & {}),
    param?: any,
    ...
    try {
        ...
        const scriptName = directScriptName? key: window._config?.scriptNames?.[key as keyof TextViewer.Config['scriptNames']];
